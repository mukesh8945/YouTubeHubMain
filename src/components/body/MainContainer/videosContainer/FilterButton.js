...
const FilterButton = ({ name, id, categoryCode, setCategoryCode }) => {
  ...
  return (
    <div onClick={() => { setCategoryCode(id); window.scrollTo(0, 0); }}
      className={`mx-1 md:mx-2 cursor-pointer px-4 py-3 h-8 flex items-center  justify-center 
      ${id === categoryCode ? darkTheme ? "bg-white" : "bg-[#606060] md:bg-[#0f0f0f]"
          : darkTheme ? "bg-[#ffffff1a] hover:bg-[#3a3a3a]  active:bg-[#575656]"
